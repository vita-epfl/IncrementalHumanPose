...
class IncrementalData:
    def __init__(self, dataset_name="CIFAR10", batch_size=128, incremental_class=0, data_root="./data"):
        ...
        # TODO: Validation dataset Problem: getting the same classes out from both training and val datasets
